...
*/
get_header(); ?>
<div class="contain2 child_page child_page_hero_img in" style="padding-bottom: 90px !important">
	<h1 class="h4">Adopt a Tenth Life Cat</h1>
	<h2 class="big mobile_small_big">Cats to adopt in St. Louis, Missouri</h2>
</div>
<div class="container">
	...
	<div class="row adopt_me">
		...
		<div class="col-lg-2 col-sm-12">
			<div class="filter-container">
				...
				<ul>
					<li class="filter" data-filter=".genderMale">Male</li>
					<li class="filter" data-filter=".genderFemale">Female</li>
				</ul>
				</div>
				
				<div class="divide20 notablet1 notablet2"></div>
				<div class="filter_container_2">
					<h5>Filter by Age</h5>
				<ul>
					<li class="filter" data-filter=".ageYoung">Young</li>
					<li class="filter" data-filter=".ageAdult">Adult</li>
					<li class="filter" data-filter=".ageSenior">Senior</li>
				</ul>
				</div>
			</div>
		</div>

		<div class="col-lg-10 col-sm-12 adopt_parent_margins">
    ...
    while ($wp_query->have_posts()) : $wp_query->the_post();
			...
			<div class="mix lm_order age<?php the_field( 'age' ); ?>  gender<?php the_field( 'gender' ); ?>">
				<div class="lm">
					<a href="<?php the_permalink(); ?>">
						<div class="litter">
							...
							<img src="<?php the_field( 'cat_picture_1' ); ?>" alt="Adopt <?php the_field( 'cat_name' ); ?> the Cat">
