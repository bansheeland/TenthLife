...
<div class="lighter_orange_bg">
    ...
    <div class="container homepage_intro_orange">
        <div class="row">
            <div class="col-md-4">
                <div class="br8  home_tres" style="background:#ea7114">
                    <div class="ht1">
                        <h2 class="white">Make a donation to Tenth Life</h2>
                        <p class="white">Help Tenth Life continue to care for our cats with a donation</p>
                        <a href="/donate/"><button class="outline">Make a Donation</button></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <a href="/adopt/" class="hideshw">
                    <div class="br8 white_bg home_tres">
                         ...
                         <img src="/wp-content/uploads/homepage-middle-2.jpg" class="ht2_img " alt="Tenth Life St. Louis">
                    <div class="ht2">
                        <h2 class="orange">Adopt at Tenth Life</h2>
                    </div>
...
<div class="mid_banner_hp">
    <img src="/wp-content/uploads/homepage-mid-banner-cat.jpg" alt="Cat Lounge in St. Louis" class="mid_banner_hp_img">
    <div class="mid_banner_hp_circle center">
       <div class="hp_banner_ciricle_inner">
        ...
        <h2 class="orange">Visit the Tenth Life Adoption Lounge</h2>
        <a><button class="outline">Find Out More</button></a>
        </div>
    </div>
</div>
