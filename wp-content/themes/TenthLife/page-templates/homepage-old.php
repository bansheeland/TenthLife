<?php
/**
* Template Name: ZZ - Defferred Home
...
<div class="home_container">
	...
	<div class="row">
			<div class="col-lg-6">
				<div class="home_hero_block_text br5">
					<h4>Welcome to Tenth Life Cats</h4>
					<h1>Giving cats the lives they deserve</h1>
				<div class="divide20"></div>
				<a href="/donate/"><button class="orange_bg big_btn btn_margin_right">Donate</button></a>
				<a href="/adopt/"><button class="orange_bg big_btn">Our cats</button></a>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="contain in">
		<p>Tenth Life provides veterinary care, foster homes, and adoptive placement to stray cats and kittens, prioritizing those with special needs. We work to end unnecessary euthanasia and cat homelessness through educational outreach, community programs, and collaborative partnerships.</p>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-7">
				<div class="hp_orange_gradient sh br10">
					<div class="hp_orange_gradient_text">
						<h2>Change a life forever and adopt a Tenth Life Cat</h2>
						<p>Check out the cats currently available for adoption at Tenth Life and plan your visit to meet him or her!</p>
						<a class="link ol" href="/adopt/"><span style="color:black">adopt a cat</span></a>
					</div>
					<div class="divide10"></div>

					<img src="/img/about/cat-3.png" alt="Adopt a cat St. Louis" class="hp_orange_block_cat">
				</div>
			</div>

			<div class="col-lg-5">
				<div class="hp_box_mission hp_box_mission_top hmpbl sh br10">
					<img src="/img/homepage/hp-mission.jpg" alt="Tenth Life Cat Adoptions St. Louis">
					<div class="overlay"></div>
					<div class="pad50">
						<h3>Our mission</h3>
						<div class="divide10"></div>
						<a class="link ol" href="/about-us/"><span>find out more</span></a>
					</div>
				</div>

				<div class="divide50 nophone notablet1 notablet2"></div>

				<div class="hp_box_mission  hp_box_mission_top hmpbr sh br10 pmb0">
					<img src="/img/homepage/hp-space.jpg" alt="Tenth Life Cat Adoptions St. Louis">
					<div class="overlay"></div>
					<div class="pad50">
						<h2 class="h3">Hang out with our cats</h2>
						<a class="link ol" href="/about-us/our-shelter/"><span>our space</span></a>
					</div>
				</div>
	...
	<div class="contain2 in">
		<h3 class="big mb0">Find out how you can get involved</h3>
	</div>

	<div class="container hp_img_bottoms">
		<div class="row row5">
			<div class="col-sm-4">
				<a href="/foster/">
					<div class="bottom_img_box orange_bg">
						<h2 class="h3">Foster</h2>
						<p>Help give cats a happy and safe home by becoming a foster to one or multiple cats</p>
			...
			<div class="col-sm-4">
				<a href="/volunteer/">
					<div class="bottom_img_box green_bg">
						<h2 class="h3">Volunteer</h2>
						<p>Join the Tenth Life team and volunteer at events and/or our Adoption Loung </p>
			...
			<div class="col-sm-4">
				<a href="/in-the-community/upcoming-events/">
					<div class="bottom_img_box pink_bg">
						<h2 class="h3">Our Events</h2>
						<p>Come to one of Tenth Life's events or learn how to become a corporate sponsor</p>
...
<div class="container">
	<h2 class="orange">Available for Adoption</h2>
</div>
<div class="adopt_random">
