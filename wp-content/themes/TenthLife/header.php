            ...
            <div class="slide_in_nav_text">
                <div class="row eq">
                    <div class="col-md-4 col-sm-12 slide_in_nav_text_first">
                        ...
                        <li><a href="/all-about-cats/">Foster</a></li>
                    ...
                    <div class="col-md-8 col-sm-12">
                        ...
                        <div class="col-md-4 col-sm-12 slide_in_nav_text_second">
                            ...
                            <div class="menu_click">
                                <h4>Resources</h4>
                                <li><a href="/resources/foundcat/">Admissions Request</a></li>
                                <li><a href="/resources/foundcat/">Lost & Found Cats</a></li>
                                <li><a href="/resources/foundcat/">Medical Resources</a></li>
                                <li><a href="/resources/foundcat/">Cat Blog</a></li>
                            </div>
                        </div>
